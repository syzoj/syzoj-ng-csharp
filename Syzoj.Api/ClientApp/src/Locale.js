export var locale = {
    "syzoj.error.problemsetNotFound": "未找到该题库。",
    "syzoj.error.problemsetNotViewable": "无法查看该题库。",
    "syzoj.error.problemsetNotEditable": "无法编辑该题库。",
    "syzoj.error.problemsetCreateNotAllowed": "无法向题库添加题目。",
    "syzoj.error.problemsetProblemNotFound": "题目不存在。",
    ...
    "syzoj.error.invalidProblemType": "无效的题目类型。"
};