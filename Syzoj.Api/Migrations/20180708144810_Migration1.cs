        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Identifiers = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyEntryId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Replies_Discussions_DiscussionEntryId",
                        column: x => x.DiscussionEntryId,
                        principalTable: "Discussions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Replies_Replies_ReplyEntryId",
                        column: x => x.ReplyEntryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Replies_DiscussionEntryId",
                table: "Replies",
                column: "DiscussionEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_Replies_ReplyEntryId",
                table: "Replies",
                column: "ReplyEntryId");
        }
