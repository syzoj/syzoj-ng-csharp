...
{
    public class StandardProblemObjectLocator : IObjectLocator
    {
        private readonly IServiceProvider provider;
        public StandardProblemObjectLocator(IServiceProvider provider)
        {
        ...
        public Uri GetUri()
            => new Uri("object:///Syzoj.Api/problem-standard/problem/");
